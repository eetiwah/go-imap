...
import (
	...
	"github.com/eetiwah/go-imap/backend"
	"github.com/eetiwah/go-imap/responses"
...
// Wiki entry (upstream project wiki): Using-extensions
...
// Wiki entry (upstream project wiki): Using-authentication-mechanisms
